...
**따라서 BST의 탐색은 Tree부분을 참고하며 복기하도록 하고, 이번 절에서는 스스로 균형트리를 만드는 AVL에 대해서 살펴보겠다.** <br>
<br>
<br>
...
**균형을 잡는 방법 : 새로운 노드부터 균형 인수가 깨진 가장 가까운 조상 노드까지를 회전시켜야 한다!.** <br>
...
위에서 설명한 기능들은 모두 아래 코드에서 직접 확인해보자.<br>
```C
#include <stdio.h>
#include <stdlib.h>
